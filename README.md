...
1. **SSPAttack: A Simple and Sweet Paradigm for Black-Box Hard-Label Textual Adversarial Attack**. *Liu, H., Xu, Z., Zhang, X., Xu, X., Zhang, F., Ma, F., Chen, H., Yu, H., & Zhang, X.*. Proceedings of the AAAI Conference, 2023. `decision`[[pdf](https://ojs.aaai.org/index.php/AAAI/article/view/26553)][[code](https://github.com/SSPAttackDemo/SSPAttack)]
